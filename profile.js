...
document.addEventListener('DOMContentLoaded', function() {
    ...
    profileForm.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            document.getElementById('user-name').textContent = `${firstNameValue} ${lastNameValue}`;
    ...
    const trackOrderBtns = document.querySelectorAll('.order-actions .btn-secondary');
    ...
    const settingCheckboxes = document.querySelectorAll('.setting-label input[type="checkbox"]');
    
    settingCheckboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            const setting = this.closest('.setting-item').querySelector('.setting-label').textContent.trim();
    ...
    function updateWishlistCount() {
        ...
        const wishlistBadge = document.querySelector('#wishlist-section .stat-badge');
        if (wishlistBadge) {
    ...
    document.querySelectorAll('.nav-link, button, input, select, textarea').forEach(element => {
        ...
        input.addEventListener('input', function() {
            if (!input.hasAttribute('readonly')) {
                ...
                autoSaveTimeout = setTimeout(() => {
                    ...
                    localStorage.setItem('occasio_profile_draft', JSON.stringify(draftData));
                }, 1000);
            }
        });
    });
